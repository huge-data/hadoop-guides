...
public class TextPairTest extends WritableTestBase {
	...
	private final TextPair tp1 = new TextPair("a", "b");
	private final TextPair tp2 = new TextPair("b", "a");
	private final TextPair tp3 = new TextPair("a", "ab");
	private final TextPair tp4 = new TextPair("aa", "b");
	private final TextPair tp5 = new TextPair(nTimes("a", 128), "b");
	private final TextPair tp6 = new TextPair(nTimes("a", 128), nTimes("a", 128));
	private final TextPair tp7 = new TextPair(nTimes("a", 128), nTimes("b", 128));
	...
	public void testNTimes() {
		assertThat(nTimes("a", 10), is("aaaaaaaaaa"));
	}
